...
<body>
    ...
    <div class="container h1 text-center mt-5 mb-5">THÊM KHÁCH HÀNG:</div>
    ...
    <form action="{{ route('validateCustomer') }}" method="post" enctype="multipart/form-data">
        @csrf
        <table class="container w-50 text-center table table-bordered">
            <tr>
                <td><label for="name">Tên</label></td>
                <td><input class="text-center " type="text" id="name" name="name" value=""></td>
            </tr>
            <tr>
                <td><label for="email">Email</label></td>
                <td><input class="text-center " type="email" id="email" name="email" value=""></td>
            </tr>
            <tr>
                <td><label for="phone">Điện thoại</label></td>
                <td><input class="text-center " type="text" id="phone" name="phone" value=""></td>
            </tr>
            <tr>
            ...
            <tr>
                <td></td>
                <td><input class="btn btn-success text-center " type="submit" value="Thêm mới"></td>
            </tr>
        </table>
    </form>
